...
<Dialog {open} title="About" width="600px" onclose={handleClose}>
	<div class="about-content">
		...
		<div class="quick-links">
			<a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" class="quick-link">
			...
			<a href={bugReportUrl()} target="_blank" rel="noopener noreferrer" class="quick-link">
				<svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
					<path
						fill="currentColor"
			...
			<a href={featureRequestUrl} target="_blank" rel="noopener noreferrer" class="quick-link">
				<svg viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
					<path
						fill="currentColor"
